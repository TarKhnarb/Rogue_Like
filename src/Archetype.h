...
struct Archetype{
    ...
    const float itemBag[10][2] =
            {{665, 371}, {665, 423}, {665, 475}, {665, 527}, {665, 579},
             {785, 371}, {785, 423}, {785, 475}, {785, 527}, {785, 579}};

    const float itemStuff[6][2] =
            {{422, 375}, {422, 430}, {422, 485},
             {557, 375}, {557, 430}, {557, 485}};

    const float inventoryAspen[2] = {485, 405};

    const float chestInventory[2] = {400, 360};

    const float itemChest[20][2] =
            {{431, 97}, {523, 97}, {615, 97}, {707, 97}, {799, 97},
             {431, 162}, {523, 162}, {615, 162}, {707, 162}, {799, 162},
             {431, 227}, {523, 227}, {615, 227}, {707, 227}, {799, 227},
             {431, 292}, {523, 292}, {615, 292}, {707, 292}, {799, 292}};
